...
func (c *configs) Apply(ctx context.Context, config *samplesv1.ConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Config, err error) {
	if config == nil {
...
func (c *configs) ApplyStatus(ctx context.Context, config *samplesv1.ConfigApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Config, err error) {
	if config == nil {
		return nil, fmt.Errorf("config provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
