...
// Copied from https://github.com/cilium/cilium/blob/3607c4139c2477368b60bed922ca3eb7a0bbb13c/go.mod#L320-L322

// Using private fork of controller-tools. See commit msg for more context
// as to why we are using a private fork.
replace sigs.k8s.io/controller-tools => github.com/cilium/controller-tools v0.16.5-1

require github.com/cilium/cilium v1.17.0-pre.3.0.20250226122951-0fea866395d2
